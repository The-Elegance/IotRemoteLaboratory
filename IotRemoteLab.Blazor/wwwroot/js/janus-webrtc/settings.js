...
if (window.location.protocol === 'http:')
	server = "http://" + "158.160.168.246" + ":8088/janus";
else
	server = "https://" + "158.160.168.246" + ":8089/janus";
...
var iceServers = [{ urls: "turn:158.160.168.246:5349", username: "hel2x", credential: "1" }];
